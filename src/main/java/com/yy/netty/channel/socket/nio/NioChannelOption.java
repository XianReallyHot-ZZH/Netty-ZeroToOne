 ...
 * 1、NetworkChannel的SocketOption体系，大致对应的就是NioServerSocketChannelConfig和NioSocketChannelConfig
 * 2、Socket和ServerSocket的采用直接的方法调用方式设置配置,大致对应的就是DefaultServerSocketChannelConfig和DefaultSocketChannelConfig
 * 3、netty自己的channelConfig的参数管理和设置保存，大致对应的就是ChannelConfig
 *
 * @param <T>
 */
